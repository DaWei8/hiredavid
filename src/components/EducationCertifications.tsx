...
export default function EducationCertifications() {
  return (
    <section id="about" className="py-24 bg-[#f4efe6] relative border-t border-[#e0d6c5]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-stone-600 leading-relaxed">
                As a naturally curious builder, I am constantly exploring cutting-edge AI technologies, context engineering pipelines, and financial payment rails to create real commercial value.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-2xl bg-[#ffffff] border border-[#e7e1d4] shadow-xs">
              ...
              <h3 className="text-lg font-bold text-stone-900 mb-1">{PERSONAL_INFO.degree}</h3>
              <div className="text-sm text-stone-600 font-medium mb-3">{PERSONAL_INFO.institution} • 2024</div>
            ...
            <div className="space-y-2">
              {CERTIFICATIONS.map((cert, idx) => (
                <div key={idx} className="p-3 rounded-xl bg-[#ffffff] border border-[#e7e1d4] flex items-center gap-3 shadow-xs">
                  <Award className="w-4 h-4 text-stone-700 shrink-0" />
                  <div>
                    <span className="text-sm font-semibold text-stone-800">{cert.title}</span>
                    <span className="text-xs text-stone-400 ml-2">— {cert.issuer}</span>
                  </div>
                </div>
              ))}
            </div>
